---
title: "Understanding the Spring Framework Transaction Abstraction :: Spring Framework"
...
|  | The preceding definition of the `dataSource` bean uses the `<jndi-lookup/>` tag from the `jee` namespace. For more information see [The JEE Schema](https://docs.spring.io/spring-framework/reference/integration/appendix.html#xsd-schemas-jee). |
| --- | --- |
