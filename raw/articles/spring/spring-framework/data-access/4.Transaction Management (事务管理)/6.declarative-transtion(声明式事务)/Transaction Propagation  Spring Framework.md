...
![tx prop required](https://docs.spring.io/spring-framework/reference/_images/tx_prop_required.png)
...
## Understanding PROPAGATION\_REQUIRES\_NEW

![tx prop requires new](https://docs.spring.io/spring-framework/reference/_images/tx_prop_requires_new.png)
