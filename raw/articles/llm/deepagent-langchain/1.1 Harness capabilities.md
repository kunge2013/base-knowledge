...
For configuration details, see [Context engineering](https://docs.langchain.com/oss/python/deepagents/context-engineering).

## Code execution

When you use a [sandbox backend](https://docs.langchain.com/oss/python/deepagents/sandboxes), the harness exposes an `execute` tool that lets the agent run shell commands in an isolated environment. This enables the agent to install dependencies, run scripts, and execute code as part of its task.
...
For setup, providers, and file transfer APIs, see [Sandboxes](https://docs.langchain.com/oss/python/deepagents/sandboxes).
...
For configuration details and examples, see [Memory](https://docs.langchain.com/oss/python/deepagents/customization#memory).
