---
title: "xoai/sage-wiki: An LLM-compiled personal knowledge base.  Drop in your papers, articles, and notes. sage-wiki compiles them into a structured, interlinked wiki — with concepts extracted, cross-references discovered, and everything searchable."
source: "https://github.com/xoai/sage-wiki"
author:
published:
created: 2026-04-08
description: "An LLM-compiled personal knowledge base.  Drop in your papers, articles, and notes. sage-wiki compiles them into a structured, interlinked wiki — with concepts extracted, cross-references discovered, and everything searchable. - xoai/sage-wiki"
tags:
  - "clippings"
---
## sage-wiki
...
sage-wiki.mp4<video src="https://private-user-images.githubusercontent.com/126380/573919239-c35ee202-e9df-4ccd-b520-8f057163ff26.mp4?jwt=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJnaXRodWIuY29tIiwiYXVkIjoicmF3LmdpdGh1YnVzZXJjb250ZW50LmNvbSIsImtleSI6ImtleTUiLCJleHAiOjE3NzU2NTY1MTEsIm5iZiI6MTc3NTY1NjIxMSwicGF0aCI6Ii8xMjYzODAvNTczOTE5MjM5LWMzNWVlMjAyLWU5ZGYtNGNjZC1iNTIwLThmMDU3MTYzZmYyNi5tcDQ_.LT4DXUOHqO6-HPLxEGOe--cc_k-0rr6_zsoqxqITtQA" controls="controls"></video>
...
[![Compiler Pipeline](https://github.com/xoai/sage-wiki/raw/main/sage-wiki-compiler-pipeline.png)](https://github.com/xoai/sage-wiki/blob/main/sage-wiki-compiler-pipeline.png)
...
[![Sage-Wiki Architecture](https://github.com/xoai/sage-wiki/raw/main/sage-wiki-webui.png)](https://github.com/xoai/sage-wiki/blob/main/sage-wiki-webui.png)
...
[![MCP Integration](https://github.com/xoai/sage-wiki/raw/main/sage-wiki-interfaces.png)](https://github.com/xoai/sage-wiki/blob/main/sage-wiki-interfaces.png)
...
See the full setup guide: [MCP Knowledge Capture Guide](https://github.com/xoai/sage-wiki/blob/main/docs/guides/mcp-knowledge-capture.md)

## Benchmarks

Evaluated on a real wiki compiled from 1,107 sources (49.4 MB database, 2,832 wiki files).

Run `python3 eval.py .` on your own project to reproduce. See [eval.py](https://github.com/xoai/sage-wiki/blob/main/eval.py) for details.
...
[![Sage-Wiki Architecture](https://github.com/xoai/sage-wiki/raw/main/sage-wiki-architecture.png)](https://github.com/xoai/sage-wiki/blob/main/sage-wiki-architecture.png)
