...
| -------------------------------------------------------------------------- | --------------------- | ----------------------------------------------------------------------- |
| [01-basic-definition.py](01-basic-definition.py)         | Basic Tool Definition | `@tool` decorator, type hints → schema, docstring → description         |
| [02-customize-properties.py](02-customize-properties.py) | Customize Properties  | Custom name/description, docstring parsing, `parse_docstring`           |
| [03-pydantic-schema.py](03-pydantic-schema.py)           | Pydantic Schema       | Complex nested inputs, field validation, optional fields                |
| [04-context-access.py](04-context-access.py)             | Context Access        | `config` (immutable), `runtime` (state/store), reserved parameter names |
| [05-tool-node.py](05-tool-node.py)                       | ToolNode (LangGraph)  | Parallel execution, error handling, routing                             |
| [06-prebuilt-tools.py](06-prebuilt-tools.py)             | Prebuilt Tools        | Wikipedia, Arxiv, langchain-community ecosystem                         |
| [07-server-side-tools.py](07-server-side-tools.py)       | Server-Side Tools     | Rate limiting, auth, validation, security best practices                |
|                                                                            |                       |                                                                         |
